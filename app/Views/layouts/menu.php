<aside class="app-sidebar">
    <div class="app-sidebar__user">
        <!-- <img class="app-sidebar__user-avatar" src="https://randomuser.me/api/portraits/men/1.jpg" width="30%" alt="User Image"> -->
        <div>
    ...
    <ul class="app-menu">
        ...
        <?php if (session()->get('level') == 'Pengguna') : ?>
            <li><a class="app-menu__item" href="<?= base_url('disposisi'); ?>"><i class="app-menu__icon fas fa-paperclip"></i><span class="app-menu__label">Disposisi</span></a></li>
        <?php endif; ?>
    </ul>
</aside>