...
class Disposisi extends BaseController
{
    ...
    public function read()
    {
        ...
        ->select("surat_masuk.*, jenis.nama_jenis, disposisi.isi_disposisi")
        ->join('jenis', 'jenis.id=surat_masuk.id_jenis', 'left')
        ->join('disposisi', 'disposisi.surat_masuk_id=surat_masuk.id', 'right')
        ->join('unit_kerja', 'unit_kerja.id=disposisi.unit_kerja_id', 'left')
        ->where('id_user', session()->get('uid'))
        ->findAll();
